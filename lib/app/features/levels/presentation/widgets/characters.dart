...
import 'package:shadow_game/app/features/levels/presentation/widgets/spider_widget.dart';
      ...
      children: [
        ...
        Positioned(
          ...
          child: GestureDetector(
            ...
            child: CustomGif(
              images: dogState.currentAnimation.images,
              width: 80,
              loop: dogState.currentAnimation.loop,
        ...
        Positioned(
          ...
          child: GestureDetector(
            ...
            child: CustomGif(
              images: playerState.currentAnimation.images,
              width: 50,
              loop: playerState.currentAnimation.loop,
